...
const baseConfig = {
  ...
  banner: {
    js: `/*!
 * SmileFlow Accessibility Widget v${packageJson.version}
...
// Build targets
const targets = {
  esm: { format: 'esm', outfile: 'dist/smileflow-accessibility.esm.js' },
  cjs: { format: 'cjs', outfile: 'dist/smileflow-accessibility.cjs.js' },
  umd: { format: 'iife', outfile: 'dist/smileflow-accessibility.umd.js', globalName: 'SmileFlowAccessibility' }
};
